...
{
    // For signed arithmetic right shift, we use l1 shifted by l2
    // The .ashr() method handles signed arithmetic right shift correctly
    return l1.ashr(l2);
}

extern "C" APInt absright_c(APInt l1, APInt r1, APInt l2, APInt r2)
{
    // For signed arithmetic right shift, we use r1 shifted by l2
    // The .ashr() method handles signed arithmetic right shift correctly
    return r1.ashr(l2);
}
