"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %10 = "func.call"(%1, %8) <{callee = @add_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.sub"(%0, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%0, %9) <{callee = @sub_nsw}> : (!transfer.integer, !transfer.integer) -> i1
