"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer):
    ...
    %7 = "func.call"(%4, %5) <{callee = @add_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    ...
    %11 = "func.call"(%1, %8) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "arith.andi"(%3, %7) : (i1, i1) -> i1
