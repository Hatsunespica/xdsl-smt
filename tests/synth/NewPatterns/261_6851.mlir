"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer):
    ...
    %12 = "transfer.or"(%0, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%0, %9) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %14 = "transfer.or"(%6, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %15 = "func.call"(%6, %12) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
