"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %8 = "transfer.shl"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "func.call"(%1, %0) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %10 = "func.call"(%1, %0) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.or"(%5, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%5, %8) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
