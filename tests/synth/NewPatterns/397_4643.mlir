"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %10 = "transfer.shl"(%3, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%3, %2) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "func.call"(%3, %2) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    ...
    %15 = "transfer.or"(%7, %13) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %16 = "func.call"(%7, %13) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
