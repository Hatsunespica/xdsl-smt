"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %12 = "transfer.shl"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%2, %1) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %14 = "func.call"(%2, %1) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %15 = "transfer.or"(%10, %12) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %16 = "func.call"(%10, %12) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %17 = "transfer.or"(%0, %15) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %18 = "func.call"(%0, %15) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %19 = "arith.andi"(%6, %8) : (i1, i1) -> i1
