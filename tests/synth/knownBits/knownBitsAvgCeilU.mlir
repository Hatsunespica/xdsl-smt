"builtin.module"() ({
 ...
 "func.func"() ({
  ...
  ^bb0(%arg0: !transfer.integer, %arg1: !transfer.integer):
    ...
    %result = "transfer.add"(%ori, %lshri) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  }) {function_type = (!transfer.abs_value<[!transfer.integer,!transfer.integer]>,!transfer.abs_value<[!transfer.integer,!transfer.integer]>) -> !transfer.abs_value<[!transfer.integer,!transfer.integer]>, sym_name = "AvgCeilUImpl", applied_to=["comb.xxx"], CPPCLASS=["circt::comb::XXXOp"], is_forward=true} : () -> ()
