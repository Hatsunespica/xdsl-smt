"builtin.module"() ({
  ...
  ^0(%0 : #transfer.integer, %1 : #transfer.integer, %2 : #transfer.integer, %3 : #transfer.integer, %4 : #transfer.integer, %5 : #transfer.integer):
    ...
    %8 = "transfer.xor"(%0, %2) : (#transfer.integer, #transfer.integer) -> #transfer.integer
    %9 = "transfer.add"(%1, %8) : (#transfer.integer, #transfer.integer) -> #transfer.integer
  ...
  ^0(%0 : #transfer.integer, %1 : #transfer.integer, %2 : #transfer.integer, %3 : #transfer.integer, %4 : #transfer.integer, %5 : #transfer.integer):
    ...
    %8 = "transfer.xor"(%3, %7) : (#transfer.integer, #transfer.integer) -> #transfer.integer
    %9 = "transfer.xor"(%0, %2) : (#transfer.integer, #transfer.integer) -> #transfer.integer
    %10 = "transfer.add"(%1, %9) : (#transfer.integer, #transfer.integer) -> #transfer.integer
