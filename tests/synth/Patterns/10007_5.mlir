"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer, %6 : !transfer.integer):
    ...
    %8 = "transfer.or"(%3, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %12 = "transfer.and"(%11, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer, %6 : !transfer.integer):
    ...
    %9 = "transfer.or"(%3, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "func.call"(%3, %5) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.and"(%8, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "transfer.shl"(%2, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %13 = "func.call"(%2, %1) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
