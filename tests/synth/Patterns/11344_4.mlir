"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %4 = "transfer.mul"(%2, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %5 = "transfer.mul"(%3, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%3, %3) <{callee = @mul_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "func.call"(%3, %3) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %8 = "arith.andi"(%2, %6) : (i1, i1) -> i1
