"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %3 = "transfer.shl"(%0, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %5 = "func.call"(%0, %3) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %6 = "func.call"(%0, %3) <{callee = @shl_nsw}> : (!transfer.integer, !transfer.integer) -> i1
