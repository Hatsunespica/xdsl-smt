"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %8 = "transfer.ashr"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %9 = "transfer.mul"(%2, %8) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %9 = "transfer.ashr"(%1, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.mul"(%2, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "func.call"(%2, %9) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %12 = "transfer.add"(%8, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
