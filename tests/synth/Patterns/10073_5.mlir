"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %5 = "transfer.or"(%0, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "transfer.mul"(%3, %3) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %10 = "func.call"(%0, %3) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %11 = "transfer.mul"(%5, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %12 = "func.call"(%5, %5) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
    %13 = "arith.andi"(%2, %4) : (i1, i1) -> i1
    %14 = "arith.andi"(%13, %6) : (i1, i1) -> i1
