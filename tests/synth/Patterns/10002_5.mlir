"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %6 = "func.call"(%1, %3) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.lshr"(%5, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    ...
    %10 = "func.call"(%2, %7) <{callee = @mul_nsw}> : (!transfer.integer, !transfer.integer) -> i1
