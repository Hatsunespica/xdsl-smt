"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    %4 = "transfer.sdiv"(%3, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer):
    ...
    %5 = "transfer.sdiv"(%3, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%3, %1) <{callee = @sidv_exact}> : (!transfer.integer, !transfer.integer) -> i1
    ...
    %9 = "transfer.sdiv"(%7, %2) : (!transfer.integer, !transfer.integer) -> !transfer.integer
