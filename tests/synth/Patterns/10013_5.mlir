"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer, %2 : !transfer.integer, %3 : !transfer.integer, %4 : !transfer.integer, %5 : !transfer.integer):
    ...
    %9 = "transfer.xor"(%0, %1) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %10 = "transfer.xor"(%2, %9) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %11 = "transfer.xor"(%8, %10) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    "func.return"(%6) : (i1) -> ()
  }) : () -> ()
