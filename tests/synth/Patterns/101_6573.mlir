"builtin.module"() ({
  ...
  ^0(%0 : !transfer.integer, %1 : !transfer.integer):
    ...
    %5 = "transfer.shl"(%3, %0) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %6 = "func.call"(%3, %0) <{callee = @shl_nuw}> : (!transfer.integer, !transfer.integer) -> i1
    %7 = "transfer.or"(%0, %5) : (!transfer.integer, !transfer.integer) -> !transfer.integer
    %8 = "func.call"(%0, %5) <{callee = @or_disjoint}> : (!transfer.integer, !transfer.integer) -> i1
