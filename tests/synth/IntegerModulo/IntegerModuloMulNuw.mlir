...
"func.func"() ({
 ...
 "func.func"() ({
  ...
  }) {function_type = (!transfer.abs_value<[!transfer.integer,!transfer.integer,!transfer.integer,!transfer.integer,!transfer.integer,!transfer.integer]>,!transfer.abs_value<[!transfer.integer,!transfer.integer,!transfer.integer,!transfer.integer,!transfer.integer,!transfer.integer]>) -> !transfer.abs_value<[!transfer.integer,!transfer.integer,!transfer.integer,!transfer.integer,!transfer.integer,!transfer.integer]>, sym_name = "MULImpl", applied_to=["comb.mul"], CPPCLASS=["circt::comb::MulOp"], is_forward=true} : () -> ()
  ...
  ^bb0(%arg0: !transfer.integer, %arg1: !transfer.integer):
    %nuw = "transfer.umul_overflow"(%arg0, %arg1) : (!transfer.integer, !transfer.integer) -> i1
    "func.return"(%nuw) : (i1) -> ()
